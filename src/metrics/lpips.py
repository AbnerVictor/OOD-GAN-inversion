...
def calculate_lpips(img, img2, crop_border, input_order='HWC', test_y_channel=False, strict_shape=True, net='alex', cuda=True, **kwargs):
    """Calculate LPIPS
    ...
    if loss_fn_alex is None:
        loss_fn_alex = lpips.LPIPS(net=net)  # best forward scores
