    ...
    def __getitem__(self, index):
        ...
        for bytes in gt_img_bytes:
            ...
            if self.gt_size is not None:
                img = cv2.resize(img, dsize=(self.gt_size[0], self.gt_size[1]), interpolation=cv2.INTER_LINEAR)
        ...
        img_gt = pad_square(img_gt)
        img_lr = pad_square(img_lr)
