...
from Experimental_root.ops.Face_Restoration.e4e.encoders.helpers import get_blocks, bottleneck_IR, bottleneck_IR_SE
from Experimental_root.ops.Face_Restoration.e4e.encoders.psp_encoders import GradualStyleBlock
...
class ResNetBackboneEncoder(Module):
    ...
    def __init__(self, n_styles=18, opts=None):
        ...
        for block in blocks:
            ...
            self.channels.append(block[-1].conv2.weight.shape[1])
